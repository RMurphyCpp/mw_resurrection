...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "2000.1.1.1",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
NBuildings = {
	...
	AIRBASE_CAPACITY_MULT = 25,		-- !!! Changed for MWM from 200 to 50 !!! Each level of airbase building multiplied by this, gives capacity (max operational value). Value is int. 1 for each airplane.
...
NAI = {
	...
	DIPLOMACY_LEAVE_FACTION_OPINION_FACTOR = 100.00,-- How much the opinion of countries being targeted by faction leader matters when deciding to leave a faction (democratic only)
